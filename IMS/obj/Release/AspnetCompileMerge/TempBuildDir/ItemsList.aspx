<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ItemsList.aspx.cs" Inherits="IMS.ItemsList" %>
        ...
        <td>
            <table align="center" cellpadding="0" class="auto-style4">
                ...
                <tr>
                    ...
                    <td class="auto-style55" style="background-color: #F7F7F7"><strong><span class="auto-style65">I</span>TEMS LIST</strong></td>
                ...
                <tr>
                    <td class="auto-style62" colspan="5"> <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Width="300px" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel2" RenderMode="Inline">
                        <table class="auto-style66">
                            <tr>
                                <td>Catagory</td>
                                <td>
                       
                        <telerik:RadComboBox ID="cmbCatagories"  Runat="server"  Width="300px"  Sort="Ascending" AutoPostBack="True" OnSelectedIndexChanged="cmbCatagories_SelectedIndexChanged">
                        </telerik:RadComboBox>
                                ...
                                <td>Sub-Catagory</td>
                                <td>
                        <telerik:RadComboBox ID="cmbSubCat" Runat="server"  Width="300px"  Sort="Ascending">
                        </telerik:RadComboBox>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="auto-style62" colspan="5">
                        <telerik:RadGrid ID="grdItems" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None">
                            ...
                            <MasterTableView CommandItemDisplay="Top">
                                ...
                                <Columns>
                                    <telerik:GridHyperLinkColumn AllowSorting="False" DataNavigateUrlFields="pkItemID" DataNavigateUrlFormatString="Item.aspx?ID={0}" DataTextField="ItemCode" FilterControlAltText="Filter column column" HeaderText="Code" UniqueName="column">
                                    </telerik:GridHyperLinkColumn>
                                    <telerik:GridBoundColumn DataField="itemTitle" FilterControlAltText="Filter column1 column" HeaderText="Title" UniqueName="column1">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ItemDescription" FilterControlAltText="Filter column2 column" HeaderText="Description" UniqueName="column2">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                    </telerik:GridBoundColumn>
