<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OpeningBalanceFA.aspx.cs" Inherits="IMS.OpeningBalanceFA" %>
        ...
        <td>
            <table align="center" cellpadding="0" class="auto-style4">
                ...
                <tr>
                    ...
                    <td class="auto-style55" style="background-color: #F7F7F7" colspan="3"><strong>Fixed Assets Opening Balances</strong></td>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <table class="auto-style66">
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cmbDepartment" Runat="server" AutoPostBack="True" MarkFirstMatch="True" MaxHeight="300px" OnSelectedIndexChanged="cmbDepartment_SelectedIndexChanged" ShowMoreResultsBox="True" Sort="Ascending" ValidationGroup="B" Width="300px">
                                                    </telerik:RadComboBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="cmbDepartment" ErrorMessage="Department Name" ForeColor="Red" InitialValue="0" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="cmbLocation" ErrorMessage="Location Required" ForeColor="Red" InitialValue="Choose Location" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtitemmodel" ErrorMessage="Item Model Required" ForeColor="Red" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtitembrand" ErrorMessage="Item Brand Required" ForeColor="Red" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style77">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td class="auto-style77">&nbsp;</td>
                                                <td>
                                                    <telerik:RadButton ID="btnSubmit" runat="server" ButtonType="SkinnedButton" Font-Size="10pt" Height="30px" OnClick="btnSubmit_Click" Text="Insert" ValidationGroup="A" Visible="False">
                                                    </telerik:RadButton>
                                                </td>
                                            </tr>
                                            <tr>
