<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReceivedNew.aspx.cs" Inherits="IMS.ReceivedNew" %>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-12">
                        <h2>Goods <b>Receiving</b></h2>

                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5>Goods Received Notes (GRN)</h5>
                            </div>
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="optionsRadiosInline" id="optRecvGIN" runat="server" value="G" onclick="CheckTrnsType('GIN');" />GIN Received
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="optionsRadiosInline" id="optRecvVND" runat="server" value="V" onclick="CheckTrnsType('VND');" />Vendor Recieved
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="optionsRadiosInline" id="optRecvSTF" runat="server" value="S" onclick="CheckTrnsType('STF');" />Staff Return
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="optionsRadiosInline" id="optRecvBRH" runat="server" value="B" onclick="CheckTrnsType('BRH');" />Branch Returned
                                                    </label>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <div style="float: left; margin: 5px;">
                                                        <asp:Button ID="btnSubmit" runat="server" Text="Save" class="btn btn-success" EnableViewState="False" OnClick />
                                                    </div>
                                                    <div style="float: left; margin: 5px;">
                                                        <asp:Button ID="btnBack" runat="server" Text="Back" class="btn btn-info" CausesValidation="False" OnClick  />
                                                    </div>
