<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="IssueMIR.aspx.cs" Inherits="IMS.IssueMIR" %>
        ...
        <td>
            <table align="center" cellpadding="0" class="auto-style4">
                ...
                <tr>
                    ...
                    <td class="auto-style90" style="background-color: #F7F7F7"><strong>Goods Issue Notes (GIN)</strong></td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="1" class="auto-style66">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><strong>G.I.N Number:<asp:TextBox ID="txtginno" runat="server" BorderColor="#000066" BorderWidth="1px" Enabled="False" Height="20px" style="font-size: x-small; text-align: center; font-weight: 700; margin-bottom: 0px;" TabIndex="5" Width="75px"></asp:TextBox>
                                                                        &nbsp; <a href="ReportsMain.aspx?rptname=GoodsIssueNote&amp;gino=<%=txtginno.Text%>" target="_blank" style="text-align: left">Print</a></strong></td>
                                                                    </strong></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="auto-style81">&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="auto-style81">&nbsp;</td>
                                                                    <td class="auto-style81">&nbsp;</td>
                                                                    <td>Gate Pass Number:<asp:TextBox ID="txtgpno" runat="server" BorderColor="#000066" BorderWidth="1px" Enabled="False" Height="20px" onkeydown="addItem(event);" style="font-size: x-small" TabIndex="5" Width="75px"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    <td class="auto-style81" colspan="4">&nbsp;
                                                                        <table align="center" class="auto-style109">
                                                                            <tr>
                                                                                <td style="text-align: left" valign="middle">&nbsp;&nbsp;&nbsp; <span class="auto-style81"><strong>Select Items By M.I.R No:
                                                                                    <asp:TextBox ID="txtmirno" runat="server" BorderColor="#000066" BorderWidth="1px" Height="20px" onkeydown="addItem(event);" style="font-size: x-small; text-align: center; font-weight: 700;" TabIndex="5" Width="75px"></asp:TextBox>
                                                                                    &nbsp;&nbsp;
                                                                            ...
                                                                            <Columns>
                                                                               <%-- <asp:BoundField DataField="GINCode" HeaderText="GIN Code" />--%>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Qtty Issued">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtqty" runat="server" ItemStyle-HorizontalAlign="Center" AutoPostBack="True" OnTextChanged="txtqty_TextChanged" Text='<%#Eval("Qtty") %>' Width="50px">                                                                      
                                                                                        </asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
