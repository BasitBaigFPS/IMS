<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StoreInventoryFull.aspx.cs" Inherits="IMS.StoreInventoryFull" %>
                    ...
                    <tr>
                        <td class="auto-style62" colspan="5">
                            ...
                            --%>
                               ...
                               <telerik:RadGrid ID="grdStore" runat="server" AutoGenerateColumns="False" GridLines="Both" GroupPanelPosition="Top"  AllowFilteringByColumn="True" AllowSorting="True" OnNeedDataSource="grdStore_NeedDataSource" OnItemCommand="grdStore_ItemCommand">
