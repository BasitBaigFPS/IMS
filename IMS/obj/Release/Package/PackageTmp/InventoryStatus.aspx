<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InventoryStatus.aspx.cs" Inherits="IMS.InventoryStatus" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="CSSTableGenerator">
        ...
        <table class="auto-style12">
            ...
            <tr>
                <td class="auto-style28" colspan="5">
                    <h1 style="font-weight: bold; font-size: medium; color: #000000;"><span style="text-align: center">
                        <em>CHANGE INVENTORY ITEM STATUS</em></span></h1>
                </td>
            </tr>
            ...
            <tr>
                <td class="auto-style7">&nbsp;</td>
                <td style="text-align: left"><span style="font-size: small">Item Status:&nbsp;&nbsp;&nbsp;
                </span>
                    <telerik:RadComboBox ID="cmbStatusType" Runat="server" AutoPostBack="True" MarkFirstMatch="True" Sort="Ascending" Width="392px" OnSelectedIndexChanged="cmbStatusType_SelectedIndexChanged">
                        <Items>
                            <telerik:RadComboBoxItem runat="server" Text="Discontinued" Value="Discontinued" />
                            <telerik:RadComboBoxItem runat="server" Text="Disposed" Value="Disposed" />
                            <telerik:RadComboBoxItem runat="server" Text="Deactivated" Value="Deactivated" />
