<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BulkOPBalance.aspx.cs" Inherits="IMS.BulkOPBalance" %>
        ...
        <td>
            <table align="center" cellpadding="0" class="auto-style4">
                ...
                <tr>
                    ...
                    <td class="auto-style55" style="background-color: #F7F7F7"><strong>Bulk Opening Balances</strong></td>
                                        ...
                                        <table class="auto-style66">
                                            ...
                                            <tr>
                                                <td class="auto-style77" colspan="2">
                                                    <asp:GridView ID="grdItems" runat="server" AutoGenerateColumns="False" OnRowCommand="grdItems_RowCommand" OnRowEditing="grdItems_RowEditing" OnRowUpdating="grdItems_RowUpdating" style="font-size: x-small" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="OpeningBalance">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtopbal" runat="server" Text='<%# Eval("OPBalance") %>' AutoPostBack="True" OnTextChanged="txtopbal_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="OrderLimit">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtOLimit" runat="server" Text='<%# Eval("Order Limit") %>' AutoPostBack="True" OnTextChanged="txtOLimit_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Brand">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtbrand" runat="server" Text='<%# Eval("Brand") %>' AutoPostBack="True" OnTextChanged="txtbrand_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Model">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtModel" runat="server" Text='<%# Eval("Model") %>' AutoPostBack="True" OnTextChanged="txtModel_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>                                                       
