...
namespace IMS
{
    public partial class labrequisitions : System.Web.UI.Page
    {
        ...
        public void GetUserInfo()
        {
            ...
            if (UMan.Ugid == 27 || UMan.Ugid == 29 || UMan.Ugid == 39)
            {
                if (cmbbranch.Items.Count == 0)
                {
                    ...
                    Reqman.Pkbrhid = int.Parse(cmbbranch.SelectedValue.ToString() == "" ? "19" : cmbbranch.SelectedValue.ToString());
        ...
        {
            string reqno = Reqman.GetRequisitionNo(fkbrhid);
            ...
            foreach (GridViewRow GR in GridView1.Rows)
            {
                ...
                if (GR.RowType == DataControlRowType.DataRow)
                {
                    ...
                    //string text1 = lblItem.Text;
                    {
                        ...
                        itm_amount = Double.Parse(qtty.ToString() == "" ? "0" : qtty.ToString()) * Double.Parse(rat.ToString());

                        DataRow[] ItemRow = ds.Tables[0].Select("fkItemID = '" + itemid + "'");

                        ItemRow[0]["QtyRequired"] = qtty == "" ? "0" : qtty;
