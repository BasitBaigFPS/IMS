<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" MaintainScrollPositionOnPostback="True" AutoEventWireup="true" EnableEventValidation = "false" CodeBehind="Requisitions.aspx.cs" Inherits="IMS.requisitions" %>
            ...
            <td>
                <table align="center" cellpadding="0" class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <telerik:RadTextBox ID="txtAppBudget" runat="server" Height="25px" Width="80px" Enabled="False" Style="font-weight: 700" Visible="True">
                            </telerik:RadTextBox>
                            &nbsp;Amount Required:
                        ...
                        <td style="height: 30px;">
                            <telerik:RadTextBox ID="txtPerChildCost" runat="server" Height="25px" Width="107px" Enabled="False" Style="font-weight: 700" Visible="False">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style67">Balance Amount:</td>
                        <td class="auto-style26">&nbsp;<telerik:RadTextBox ID="txtAmountBal" runat="server" Height="25px" Width="79px" Enabled="False" Style="font-weight: 700" Visible="True">
                        </telerik:RadTextBox>
                        </td>
                        <td class="auto-style18"></td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style15">
                            <telerik:RadButton ID="btnConfirm" runat="server" Text="Show Item List" Font-Size="10pt" Height="30px" ButtonType="SkinnedButton" Width="120px" OnClick="btnConfirm_Click" Style="text-align: center">
                            </telerik:RadButton>
                        </td>
                                        ...
                                        <asp:GridView ID="grdItems" runat="server"
                                            ...
                                            <Columns>
                                              ...
                                              <%--  <asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="ReqGroup" HeaderText="Requisition Group" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle"/>
                                                ...
                                                <asp:BoundField DataField="Unit" HeaderText="Unit" ItemStyle-Width="100px"/>

                                                <asp:BoundField DataField="Balance" HeaderText="In Stock Balance">
                                                    <ItemStyle Font-Bold="True" Font-Size="Larger" ForeColor="#006600" />
                                                </asp:BoundField>
                                               
                                                <asp:BoundField DataField="ProposedQtty" HeaderText="Proposed Qtty" >
                    ...
                    <tr>
                        <td class="auto-style62">&nbsp;</td>
                        <td class="auto-style26">
                            <telerik:RadButton ID="btnSubmit" runat="server" Text="Submit Requisition" Font-Size="10pt" Height="30px" ButtonType="SkinnedButton" OnClick="btnSubmit_Click" Style="text-align: center; top: 2px; left: 76px; width: 227px;">
                            </telerik:RadButton>
                        </td>
                        <td class="auto-style18">&nbsp;</td>
