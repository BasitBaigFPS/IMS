...
namespace IMS
{
    public partial class MIRequest : System.Web.UI.Page
    {
               ...
               // GetUserInfo();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (ItemRow2.Length != 0)
                    {
                        ...
                        dr["Balance"] = Single.Parse(ItemRow2[0]["CurrentBalance"].ToString() == "" ? "0" : ItemRow2[0]["CurrentBalance"].ToString());
                    }
        ...
        protected void rdoReqID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (rdoReqID.SelectedValue == "S")
                {
                    Response.Redirect("SyllabusRequisitionBranch.aspx");
                }
                else
                {
                    mirdiv.Style.Add("display", "none");
