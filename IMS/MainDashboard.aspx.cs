...
namespace IMS
{
 ...
 #region Class Level Objects
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dbm.UserGroupID == 31 || dbm.UserGroupID == 28 || dbm.UserGroupID == 37 || dbm.UserGroupID == 2084)
        {
    ...
    private void DBParaSetup()
    {
        ...
        //if (Uman.Ubrhid == 19 && Uman.Pkdeptid == 14)
        //{
        //    dbm.fkstoreid = 1;
        //    dbm.fkdepartid = 14;
        ...
        //    txtbranchID.Text = dbm.fkbrhid.ToString();
        //}
        //if (Uman.Ubrhid == 16 && Uman.Pkdeptid == 2 && dbm.UserGroupID == 2084)
        //{
        //   // dbm.fkstoreid = 26;
        //   // dbm.fkdepartid = 10;
