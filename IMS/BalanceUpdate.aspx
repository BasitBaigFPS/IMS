<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BalanceUpdate.aspx.cs" Inherits="IMS.BalanceUpdate" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Button ID="btnInvoke" runat="server" Text="Update Balance"
                                    OnClick="btnInvoke_Click" Width="107px" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
