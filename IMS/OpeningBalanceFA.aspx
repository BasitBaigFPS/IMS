                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <table class="auto-style66">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cmbBranch" Runat="server" AutoPostBack="True" MarkFirstMatch="True" OnSelectedIndexChanged="cmbBranch_SelectedIndexChanged" Sort="Ascending" Width="300px">
                                                     ...
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="cmbBranch" ErrorMessage="Choose Branch" ForeColor="Red" InitialValue="Choose Branch" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cmbStores" Runat="server" AutoPostBack="True" MarkFirstMatch="True"  Sort="Ascending" Width="300px">
                                                    </telerik:RadComboBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cmbStores" ErrorMessage="Choose Store" ForeColor="Red" InitialValue="Choose Store" ValidationGroup="A">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
