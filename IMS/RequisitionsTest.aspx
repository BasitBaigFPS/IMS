<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" maintainscrollpositiononpostback="True"  AutoEventWireup="true" CodeBehind="RequisitionsTest.aspx.cs" Inherits="IMS.RequisitionsTest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function UpdateField(txtqtt, txtrat, total) {
            if (document.getElementById(chkID).checked == true) {
                var txtval1 = document.getElementById(txtqtt).value != "" ? document.getElementById(txtqtt).value : "0";
                var txtval2 = document.getElementById(txtrat).value != "" ? document.getElementById(txtrat).value : "0";
                var total1 = parseInt(txtval1) * parseInt(txtval2);
                document.getElementById(txtamt).innerHTML = total1;
                if (document.getElementById(txtqtt).value == "" && document.getElementById(txtrat).value == "")
                    document.getElementById(txtamt).innerHTML = "";
                document.getElementById(txtqtt).disabled = false;
                document.getElementById(txtrat).disabled = false;
            }
            else {
                document.getElementById(txtqtt).disabled = true;
                document.getElementById(txtrat).disabled = true;
            }
        }
        ...
        function CalculateTotal(txtCtrl) {
            if (txtCtrl != "") {
                var txtProdQty = document.getElementById(GetClientId("txtqty"));
                var txtProdPrice = document.getElementById(GetClientId("txtrate"));
                if (txtProdQty != "") {
                    if (isNaN(txtProdQty.value) == true) {
                        alert("Please Enter Numeric Values");
                        document.getElementById(GetClientId("txtFooterQuantity")).focus();
                        return false;
                    }
                }
                if (txtProdPrice != "") {
                    txtProdPrice.value = show(txtProdPrice.value);
                }
                var txtLineTotVal = document.getElementById(GetClientId("txtFooterLineTotal"));
                if (txtProdQty.value != "" && txtProdPrice.value != "") {
                    //alert(txtProdQty.value * txtProdPrice.value)
                    var val1 = txtProdPrice.value;
                    val1 = val1.toString().replace(/\$|\,/g, '');
                    txtLineCalTotVal = txtProdQty.value * parseFloat(val1);
                    txtLineTotVal.value = show(txtLineCalTotVal);
                    document.getElementById(GetClientId("txtFooterValue")).focus();
                    document.getElementById(GetClientId("txtFooterValue")).select();
                }
            }
        }
                ...
                <table align="center" cellpadding="0" class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td class="auto-style65">
                            ...
                            &nbsp;<a href="ReportsMain.aspx?rptname=QuarterlyRequisition&amp;reqno=<%= txtReqNo.Text %>" target="_blank">Print</a><br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            ...
                            &nbsp;Amount Required:
                        <telerik:RadTextBox ID="txtAmountReq" runat="server" Height="25px" Width="79px" Enabled="False" Style="font-weight: 700" OnTextChanged="txtAmountReq_TextChanged">
                        </telerik:RadTextBox>
                        </td>
                        <td class="auto-style18">&nbsp;</td>
