...
namespace IMS
{
    ...
    public partial class IssueInventory : System.Web.UI.Page
    {
        /// <summary>
        ...
        public void GetUserInfo()
        {
            ...
            if (collection.Count != 0 && Uman.Grpuserdeptid == 14 && Uman.Grpuserstoreid!=2)
            {
        ...
        { 
            ...
            if (cmbIssueType.SelectedValue == "I" && Uman.Ugid == 28)
            {
        ...
        public void GetItems(int ithead, int token)
        {
            ...
            else
            {
                ...
                deptfromid = Uman.Grpuserdeptid;
                storeid = Uman.Grpuserstoreid;
                im.fkbrhid = Uman.Grpuserbrhid;
                ...
                if (Uman.Ugid != 38 && Uman.Ugid != 2084)
                {
       ...
       public void ConfirmItemEntry()
        {
            if (Page.IsValid)
            {
                ...
                {
                    if (int.Parse(cmbDepartmentfrom.SelectedValue.ToString()) == 10 || int.Parse(cmbDepartmentfrom.SelectedValue.ToString()) == 14)
                    {
                        ib = im.getItembalance(Uman.Grpuserbrhid, Uman.Grpuserstoreid, cmbItem.SelectedValue.ToString(), "S");
                    }
                    else
                    {
                        ib = im.getItembalance(Uman.Grpuserbrhid, Uman.Grpuserstoreid, cmbItem.SelectedValue.ToString(), "D");
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        ib = im.getItembalance(Uman.Grpuserbrhid, Uman.Grpuserdeptid, cmbItem.SelectedValue.ToString(), "D");
                    }
                ...
                else
                {
                    ...
                    //&& int.Parse(cmbstorefrom.SelectedValue.ToString()) != 22)
       ...
       public void SearchItems()
        {
            ...
            if (cmbBranchto.SelectedValue != "Search Item")
            {
                ...
                if (Uman.Ugid != 38)
                {
                   // storeid = int.Parse(cmbstorefrom.SelectedValue.ToString()=="No Store in this Branch" ? "0" : cmbstorefrom.SelectedValue.ToString());
                    ...
                    if (cmbDepartmentto.SelectedValue.ToString() != "14")
                    {
                        ...
                        if (deptfromid != 14 && deptfromid != 10)
                        {
                            di = im.GetDeptInventory(deptfromid, im.fkbrhid, 0);
                        }
                        else
       ...
       /// <param name="start">if set to <c>true</c> [start].</param>
        private void SetupForm(bool start)
        {
            ...
            {
                if (Uman.Ugid == 28 || Uman.Ugid == 30 || Uman.Ugid == 31 || Uman.Ugid == 2084)
                {
                ...
                //int.Parse(cmbbranchfrom.SelectedValue.ToString()
                
                DataSet de = im.GetEmployees(Uman.Ubrhid, int.Parse(cmbDepartmentfrom.SelectedValue.ToString()), "I");
        ...
        {
            if (cmbIssueType.SelectedValue == "I" && cmbbranchfrom.SelectedValue!="25")
            {
              Response.Redirect("IssueQuickItemsNew.aspx?issuetype=I");
            }
        ...
        {
            im.fkdepartid = int.Parse(cmbDepartmentfrom.SelectedValue.ToString());
            im.fkIssueByStoreID = int.Parse(cmbstorefrom.SelectedValue.ToString() == "No Store in this Branch" ? "0" : cmbstorefrom.SelectedValue.ToString());
        ...
        /// <summary>
        /// Handles the SelectedIndexChanged event of the cmbDepartmentto control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Handles the SelectedIndexChanged event of the cmbPersonto control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Handles the SelectedIndexChanged event of the cmbIssuedby control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs"/> instance containing the event data.</param>
        ...
        protected void btnSubmitItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
              ...
              //  im.fkdepartid = int.Parse(cmbDepartmentfrom.SelectedValue);
                ...
                if (im.pksysIDTo != 0)
                {
                    ...
                    im.fkIssueByDeptID = Uman.Grpuserdeptid;
                    im.fkIssueToDeptID = Uman.Grpuserdeptid;
                    im.fkIssueByID = Uman.Uid;
                    im.fkIssuedToID = int.Parse(cmbPersonto.SelectedValue);
                    im.IssuedStatus = cmbIssueStatus.SelectedValue;
                    im.IssuedType = cmbIssueType.SelectedValue;
                ...
                else
                {
                    ...
                    {
                        im.fkIssueByDeptID = Uman.Grpuserdeptid;
                        im.fkdepartid = Uman.Grpuserdeptid;
                        im.fkIssueToDeptID = 14;
                    }
                    else if (cmbDepartmentto.SelectedValue != "14" && Uman.Ugid != 37 || cmbDepartmentto.SelectedValue != "14" && Uman.Ugid != 2084)
                    {
                        im.fkIssueByDeptID = 2;
                        im.fkIssuedToID = int.Parse(cmbPersonto.SelectedValue.ToString() == "No Employees in Branch" ? "0" : cmbPersonto.SelectedValue.ToString());
                    }
                    else
                    {
                    ...
                    im.fkIssueByBranchID = Uman.Grpuserbrhid;
                    im.fkIssueByDeptID = Uman.Grpuserdeptid;
                    im.fkIssueByStoreID = Uman.Grpuserstoreid;
